...
import { Mail, Send, Linkedin, Github, MessageCircle, Calendar, Clock, CheckCircle, MapPin, Globe, Coffee, Zap, Phone, Video, DollarSign, FileText, Users, Target, ArrowRight } from 'lucide-react'
...
const ContactDetailed = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      response: "~1 day",
      availability: "EST Business hours"
    }
  ]
