        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {featuredProjects.map((project, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl bg-gradient-to-br ${project.color} text-white shadow-lg overflow-hidden group cursor-pointer`}
            >
              {/* Background Pattern */}
        ...
        >
          {[
            ...
            <div key={index} className="group">
              <div className="text-2xl md:text-3xl font-bold text-gradient mb-2 group-hover:scale-110 transition-transform">
                {stat.number}
              </div>
