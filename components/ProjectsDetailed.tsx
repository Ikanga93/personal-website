  ...
  const projects = [
    {
      ...
      longDescription: "Ritt.ai is a cutting-edge AI assistant that revolutionizes the drive-thru experience by taking orders with 99.5% accuracy. The system reduces wait times by up to 40% by processing orders before customers reach the window, while intelligently suggesting upsells and maintaining natural conversation flow.",
    ...
    },
    {
      ...
      longDescription: "A full-featured nonprofit management application designed to streamline operations, donor management, and community engagement. The platform helps nonprofit organizations manage donations, track volunteers, organize events, and maintain transparent communication with their community.",
    ...
    },
    {
      ...
      longDescription: "The frontend application for the Ritt AI assistant, providing restaurant staff and customers with an intuitive interface to interact with the AI ordering system. Features real-time voice visualization, order management, and comprehensive analytics dashboard.",
    ...
    },
    {
      ...
      longDescription: "A complete restaurant application for ordering and managing burrito orders with real-time tracking, menu management, and integrated payment processing. Built to provide seamless experience for both customers and restaurant staff.",
